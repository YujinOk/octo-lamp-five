...
window.addEventListener("DOMContentLoaded", () => {
  ...
  start.addEventListener("click", function (e) {
    ...
    let countDown = setInterval(callBackCountDown, 1000);
    countDown;
  });
  ...
  const quizArray = [
    ...
    {
      q: "How many times do humans fart a day",
      o: ["20-25", "25-30", "5-10", "5-15"],
      a: 2,
    },
    {
      q: "Who is the top of food chain?",
      o: ["Shark", "Homosapiens", "Zombies", "Bear"],
      a: 2,
    },
  ];
